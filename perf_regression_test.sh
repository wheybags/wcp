...
run_bench() {
  echo "running 1K test">&2; "$base_dir/bench.sh" --time-only 1K 20000
  echo "running 1M test">&2; "$base_dir/bench.sh" --time-only 1M 2000
  echo "running 512M test">&2; "$base_dir/bench.sh" --time-only 512M 20
}
